...
let chinaPopPrecent = 18.2;
let israelPopPrecent = 0.1;
let tibetPopPrecent = 0.04;

console.log(`China population precent is ${percentageOfWorld1(1441)}`);
console.log(`Israel population precent is ${percentageOfWorld1(8.9)}`);
console.log(`Tibet population precent is ${percentageOfWorld1(3.2)}`);

//////////////////////////////


let percentageOfWorld2 = (population) => { return (population / 7900) * 100;}

console.log(`China population precent is ${percentageOfWorld2(1441)}`);
console.log(`Israel population precent is ${percentageOfWorld2(8.9)}`);
console.log(`Tibet population precent is ${percentageOfWorld2(3.2)}`);
